...
new Chart(document.getElementById("pie-chart"), {
    type: 'pie',
    data: {
      labels: ["Electricity","Steam","Dom Water","Reclaimed Water","Chilled Water","Gas"],
      datasets: [{
        label: "BTU/Hour",
        ...
        data: [{{ elecDollar|safe }},{{ steamDollar|safe }},{{ domDollar|safe }},{{ reclaimedDollar|safe }},{{ chilledDollar|safe }},{{ gasDollar|safe }}]
      }]
    },
    options: {
      legend: {
