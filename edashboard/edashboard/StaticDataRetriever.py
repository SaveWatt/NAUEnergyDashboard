...
class StaticDataRetriever:
    ...
    def __init__(self):
        ...
        self.__b_identifiers = {'B1': ['Gammage','gamage'],
                         ...
                         'B25': ['Health & Learning Center', 'hlc'],
                         ...
                         'B33': ['Hotel & Restaurant Management', 'hrm'],
                         'B35': ['NAU Bookstore', 'bookstore'],
                         'B36': ['Science & Health Building', 'shb'],
                         ...
                         'B41': ['Honors Living & Learning Community', 'honors'],
                         ...
                         'B60': ['Student & Academic Services', 'sas'],
                         'B62': ['McConnell Hall', 'mcconnell'],
                         'B64': ['DuBois South Union', 'dubois'],
                         'B65': ['Social & Behavioral Sciences (Castro)', 'sbs east'],
                         'B66': ['Health Professions', 'health professions'],
                         'B69': ['Engineering & Technology', 'engineering'],
                         'B70': ['Social & Behavioral Sciences (West)', 'sbs west'],
                         ...
                         'B86': ['Aquatic & Tennis Complex', 'aquatic center'],
                         'B87': ['Skyview Apartments', 'skyview'],
                         'B88': ['Wettaw', 'wettaw'],
                         'B90': ['School of Infomatics, Computing & Cyber Systems', 'nareh'],
