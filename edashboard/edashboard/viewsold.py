...
class ExportView(View):
    ...
    def post(self, request):
        if request.is_ajax():
            ...
            bname = getBuildInfo(building)[0]
            bnum = getBuildInfo(building)[1]
            util = body['util']
            sensor = body['sensor']
            buildings = BuildingSearch.getBuildingString()
        ...
        return render(request, 'edashboard/export.html',{'date':json.dumps(self.dates), 'usage':json.dumps(self.usages),'buildlist': buildings, 'bname': bname})
